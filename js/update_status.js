...
function generateHtml(data){
	...
	html += '                                    <label for="r_address" class="col-form-label col-form-label-sm"><b>ที่อยู่</b></label>';
	html += '                                    <div>'+data.data.receiver_desc.address+'</div>';
	html += '                                </div>';
	html += '                            </div>';
	html += '                            <div class="row">';
	html += '                                <div class="col">';
	html += '                                    <label for="r_district" class="col-form-label col-form-label-sm"><b>เขต</b></label>';
	html += '                                    <div>'+data.data.receiver_desc.area+'</div>';
	html += '                                </div>';
	html += '                                <div class="col">';
	html += '                                    <label for="r_area" class="col-form-label col-form-label-sm"><b>แขวง</b></label>';
	html += '                                    <div>'+data.data.receiver_desc.district+'</div>';
	html += '                                </div>';
	html += '                            </div>';
	html += '                            <div class="row">';
	html += '                                <div class="col">';
	html += '                                    <label for="r_province" class="col-form-label col-form-label-sm"><b>จังหวัด</b></label>';
	html += '                                    <div>'+data.data.receiver_desc.province+'</div>';
	html += '                                </div>';
	html += '                                <div class="col">';
	html += '                                    <label for="r_postcode" class="col-form-label col-form-label-sm"><b>รหัสไปรษณีย์</b></label>';
	html += '                                    <div>'+data.data.receiver_desc.postal+'</div>';
	html += '                                </div>';
	html += '                            </div><hr>';
	html += '                            <div class="row">';
	html += '                                <div class="col-sm-6">';
